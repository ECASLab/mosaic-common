# Required portable checks for the technology-independent write-control leaf.
...
# Technology, destination timing, domains, scan, and activity belong to the
# first stateful integration that consumes the write enable.
