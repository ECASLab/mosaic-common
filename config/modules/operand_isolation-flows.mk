# Required portable checks for the technology-independent operand-isolation leaf.
...
# Destination timing, domains, scan, technology mapping, and activity belong to
# the first consuming datapath that uses the isolated operand.
